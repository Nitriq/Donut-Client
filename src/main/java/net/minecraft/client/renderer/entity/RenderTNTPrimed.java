    ...
    public void renderTag(RenderTNTPrimed tntRenderer, EntityTNTPrimed tntPrimed, double x, double y, double z, float partialTicks) {
            ...
            if (tntPrimed.fuse >= 1) {
                ...
                if (d0 <= 4096.0D) {
                    ...
                    if (Minecraft.getMinecraft() != null && Minecraft.getMinecraft().gameSettings != null && Minecraft.getMinecraft().gameSettings.thirdPersonView == true) {
                        xMultiplier = -1;
                    }
                    ...
                    worldrenderer.pos((double) (-j - 1), (double) (-1 + i), 0.0D).color(0.0F, 0.0F, 0.0F, 0.1F).endVertex();
                    worldrenderer.pos((double) (-j - 1), (double) (8 + i), 0.0D).color(0.0F, 0.0F, 0.0F, 0.1F).endVertex();
                    worldrenderer.pos((double) (j + 1), (double) (8 + i), 0.0D).color(0.0F, 0.0F, 0.0F, 0.1F).endVertex();
                    worldrenderer.pos((double) (j + 1), (double) (-1 + i), 0.0D).color(0.0F, 0.0F, 0.0F, 0.1F).endVertex();
                    tessellator.draw();
                    GlStateManager.enableTexture2D();
