...
import donut.gui.ServerDataFeatured;
...
public class ServerListEntryNormal implements GuiListExtended.IGuiListEntry
{
    ...
    public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected)
    {
        ...
        Gui.drawModalRectWithCustomSizedTexture(x + listWidth - 15, y, (float)(k * 10), (float)(176 + l * 8), 8, 7, 256.0F, 256.0F);
    ...
    private void drawImg(int x, int y, boolean lower, ResourceLocation texture) {
        ...
        Gui.drawModalRectWithCustomSizedTexture(x - 18, lower ? y + 12 : y, 0.0F, 0.0F, 10, 10, 10, 10);
    }
