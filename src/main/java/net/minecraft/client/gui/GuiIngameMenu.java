...
import donut.gui.InGameMultiplayer;
...
public class GuiIngameMenu extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(100, this.width / 2 - 100, this.height / 4 + 72 + i, 200, 20, I18n.format("Multiplayer", new Object[0])));
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        switch (button.id)
        {
            ...
            case 100:
                this.mc.displayGuiScreen(new InGameMultiplayer());
        }
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        ResourceLocation subTitle = new ResourceLocation("donut/Downrest.png");
        mc.getTextureManager().bindTexture(subTitle);
        Gui.drawModalRectWithCustomSizedTexture(517, 350, 0.0F, 0.0F, this.width - 520, this.height - 350, this.width - 520, this.height - 350);
    }
}
