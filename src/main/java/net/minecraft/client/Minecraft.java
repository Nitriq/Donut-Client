...
import donut.gui.mainmenu.MainMenu;
import donut.mods.impl.togglesprintsneak.DonutMovementInput;
import donut.util.Utils;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle(Donut.getInstance().NAME + " (" + Donut.getInstance().VERSION + ")"  + " 1.8.9");
    ...
    private void setWindowIcon()
    {
        ...
        if (util$enumos != Util.EnumOS.OSX)
        {
            ...
            try
            {
            	inputstream = this.mcDefaultResourcePack.getResourceStream(new ResourceLocation("donut/icon/icon16.png"));
            	inputstream1 = this.mcDefaultResourcePack.getResourceStream(new ResourceLocation("donut/icon/icon16.png"));
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    else
                    {
                        ...
                        if (k == gameSettings.HideHUD.getKeyCode())
                        {
    ...
    {
        Donut.getInstance().getDiscordRP().update("Playing SinglePlayer", "InGame");
        this.loadWorld((WorldClient)null);
        System.gc();
    ...
    public void loadWorld(WorldClient worldClientIn, String loadingMessage)
    {
        ...
        if (worldClientIn != null)
        {
            ...
            this.thePlayer.movementInput = new DonutMovementInput(this.gameSettings);
